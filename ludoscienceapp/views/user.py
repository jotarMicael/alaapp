...
def index(request):
    ...
    return render(request, 'ludoscienceapp/index.html')

def register(request):
    if System.is_logged(request):
        return redirect('home')   
    return render(request, 'ludoscienceapp/register.html')
...
def verificate(request):
    return render (request,'ludoscienceapp/verificate/verificate.html')
...
def active_account(request):
    try:
        ...
        return render (request,'ludoscienceapp/verificate/active_account.html')   
    except KeyError:
        return redirect('index')  
